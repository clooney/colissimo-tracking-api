Colissimo Tracking API - .Net
================================
Use .Net to track Colissimo shipments with Colissimo Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "9M00023526693";
                  createTrackingParams.courierCode = "colissimo";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  {
                      trackingNumber = "11526813575561",
                      courierCode = "colissimo"
                  };
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "CC067712918FR,11526813575561";
                  getTrackingResultsParams.courierCode = "colissimo";
