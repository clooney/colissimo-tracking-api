...
Create a tracking (Real-time tracking):
      ...
      begin
        params  = {"tracking_number" => "9M00023526693","courier_code"=>"colissimo"}
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "11526813575561","courier_code"=>"colissimo"},{"tracking_number" => "CC067712918FR","courier_code"=>"colissimo"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"courier_code"=>"colissimo"}
      # params  = {"tracking_numbers" => "11526813575561,CC067712918FR","courier_code"=>"colissimo"}
...
Update a tracking by ID:
    ...
    begin
      ...
      id_string = '99e4d7a934ac7e2e111379ba93afe58a'
