Colissimo Tracking API - Python
================================
Use Python to track Colissimo shipments with Colissimo Tracking API.
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    try:
      params = [
        {'tracking_number': '11526813575561', 'courier_code': 'colissimo'},
        {'tracking_number': 'CC067712918FR', 'courier_code': 'colissimo'}
      ]
...
Get status of the shipment:
    ...
    try:
      ...
      # params = {'tracking_numbers': '92642903289511563030094932,803123605795913930', 'courier_code': 'colissimo'}
