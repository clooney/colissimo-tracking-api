Colissimo Tracking API - Go
================================
Use Go to track Colissimo shipments with Colissimo Tracking API.
...
Update a tracking by ID:
    ...
    func main() {
      ...
      idString := "99e4d7a934ac7e2e111379ba93afe58a"
